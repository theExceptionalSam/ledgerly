...
router.get('/fee-templates', asyncHandler(ctrl.listTemplates));

router.post('/fee-templates', requireRole('owner', 'accountant'), [
...
router.post('/fee-templates/:id/apply', requireRole('owner', 'accountant'), [
  param('id').isUUID(),
